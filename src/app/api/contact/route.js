...
export async function POST(req) {
  try {
    ...
    // Default value set kar di taki agar Service form na ho to error na aaye
    const { name, email, phone, pkg = "General Inquiry", message } = body;
      ...
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: auto; border: 1px solid #eee; border-radius: 10px; overflow: hidden;">
          ...
          <div style="padding: 20px; color: #333;">
            <p><strong>Source/Package:</strong> <span style="color: #0891b2; font-weight: bold;">${pkg}</span></p>
      ...
      html: `
        <div style="font-family: sans-serif; max-width: 600px; margin: auto; border: 1px solid #e5e7eb; border-radius: 16px; overflow: hidden;">
          ...
          <div style="padding: 30px; line-height: 1.6; color: #1f2937;">
            ...
            <p>Thank you for reaching out to us. We’ve successfully received your inquiry regarding <strong>${pkg}</strong>.</p>
            <p>Our technical team is already looking into your requirements. We’ll contact you on <strong>${phone}</strong> shortly.</p>
