...
const services = [
  ...
  },
  {
    ...
    desc: "Our tech experts create high-performance, responsive websites using Next.js and Tailwind, ensuring a seamless experience for your users.",
    icon: "💻",
  ...
  },
  {
    ...
    desc: "From SEO to targeted PPC campaigns, we ensure your brand reaches the right audience and converts visitors into loyal customers.",
    icon: "📢",
